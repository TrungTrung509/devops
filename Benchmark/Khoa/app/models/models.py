...
class Enrollment(Base):
    ...
    userId = Column(String, nullable=False)        # Bỏ FK: SV chéo Khoa không có trong bảng users cục bộ
    MaLopHP = Column(String, nullable=False)       # Bỏ FK: Cho phép ghi linh hoạt
    MaHP = Column(String, nullable=False)
    MaHocKy = Column(String, nullable=False)
...
class EnrollmentTransfer(Base):
    ...
    userId = Column(String, nullable=False)  # Bỏ FK
